...
# What happens if you increase the size of the strings?
    ...
    puts Benchmark.measure { first_anagram?("blue", "clue") } # => false
    # Commented out these last tests because they take a few minutes each test
    # puts Benchmark.measure { first_anagram?("hippopotamus", "hippo") } # => false
...
# What are the differences between #first_anagram? and #second_anagram??
    ...
    puts Benchmark.measure { second_anagram?("electionresults", "liesletsrecount") }
...
# Is it better or worse than #second_anagram??
    ...
    puts Benchmark.measure { third_anagram?("electionresults", "liesletsrecount") }
...
# times each letter appears in both words. Compare the resulting hashes.
    ...
    puts Benchmark.measure { fourth_anagram?("electionresults", "liesletsrecount") }
...
# Bonus: Do it with only one hash.
    ...
    puts Benchmark.measure { bonus_anagram?("electionresults", "liesletsrecount") }
